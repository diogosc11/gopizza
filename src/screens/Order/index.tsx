...
import { Platform, Alert, ScrollView, StyleSheet, TouchableOpacity, ActivityIndicator, Text } from 'react-native';
  ...
  useEffect(() => {
    if (id) {
      firestore()
        ...
        .catch(() => Alert.alert('Pedido', 'Não foi possível carregar o pedido.'));
    }
  }, [id]);
    ...
    <Container behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <Form>
          ...
          <TouchableOpacity onPress={handleOrder} style={styles.addProductButton}>
            {isLoading ? <ActivityIndicator size="large" color="#FFF" /> : <Text style={{ color: "#FFF" }}>Confirmar pedido</Text>}
          </TouchableOpacity>
        </Form>
      </ScrollView>
    </Container>
